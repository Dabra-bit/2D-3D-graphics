...
public class Project extends JFrame {
    ...
    public Project() {
        ...
        t = 0;
        fondo = new BufferedImage(1000, 1000, BufferedImage.TYPE_3BYTE_BGR);
    ...
    private void inicializar() {
        ...
        setTitle("Project Tanque 2 Guerra 6M 18110023 Bernachi");
        setResizable(false);
    ...
    public void dibujar(BufferedImage img, double t) {
        ...
        rellenarRectangulo(img, 80, 280, 680, 450, Color.DARK_GRAY);// Cuerpo Azul
        rellenarRectangulo(img, 100, 120, 480, 400, Color.DARK_GRAY);// Cabina
        rellenarRectangulo(img, 100, 150, 260, 240, Color.gray);// Ventanas
        rellenarRectangulo(img, 175, 150, 185, 240, Color.BLACK);// Marco
        rellenarRectangulo(img, 520, 250, 500, 279, Color.CYAN);// Espejo
        rellenarRectangulo(img, 680, 280, 700, 450, Color.GRAY);// Blindaje
        rellenarRectangulo(img, 200, 210, 750, 150, Color.DARK_GRAY);// Cañon
        rellenarRectangulo(img, 0, 510, 800, 500, Color.DARK_GRAY);// Vias

        rellenarCirculo(img, encerrar(-150, 700, 900), 180, 30, Color.RED);// Disparo

        rellenarCirculo(img, encerrar(-100, 700, 425 - (int) (300 * t)), 150 + (int) (50 * st), 30, Color.DARK_GRAY);
        rellenarCirculo(img, encerrar(-100, 700, 400 - (int) (300 * t)), 170 + (int) (50 * ct), 30, Color.DARK_GRAY);
        rellenarCirculo(img, encerrar(-100, 700, 450 - (int) (300 * t)), 150 + (int) (50 * ct), 30, Color.DARK_GRAY);
